...
if (basename(dirname($_SERVER['REQUEST_URI'])) === 'admin') { ?>
    <p class="text-right font-weight-light">SIVTALE EMR <?php echo APP_VERSION ?> &nbsp; · &nbsp; <a target="_blank" href="https://docs.itflow.org">Docs</a> &nbsp; · &nbsp; <a target="_blank" href="https://forum.itflow.org">Forum</a> &nbsp; · &nbsp; <a target="_blank" href="https://services.itflow.org">Services</a></p>
    <br>
<?php } ?>
<?php
...
<p class="text-center">
    <?php
        ...
        if (!$config_whitelabel_enabled) {
            echo '<br><small class="text-muted">Powered by SIVTALE </small>';
        }
    ?>
</p>
<?php } ?>
