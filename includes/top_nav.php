...
<nav class="main-header navbar navbar-expand navbar-<?php echo nullable_htmlentities($config_theme); ?> navbar-dark">
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <!-- SEARCH FORM -->
        <form class="form-inline" action="/clinic/global_search.php">
        ...
        <li class="nav-item dropdown user-menu">
            ...
            <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                ...
                <li class="user-footer">
                    ...
                    <a href="/clinic/user/user_details.php" class="btn btn-default btn-flat"><i class="fas fa-user-cog mr-2"></i>Account</a>
                    <a href="/logout.php" class="btn btn-default btn-flat float-right"><i class="fas fa-sign-out-alt mr-2"></i>Logout</a>
                </li>
            </ul>
        </li>
